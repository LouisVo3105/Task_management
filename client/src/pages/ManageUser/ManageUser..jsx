...
function ManageUser() {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      console.log('User list data from server:', data);
      setUsers(data.data || []);
    } catch (err) {
  ...
  const handleSubmit = async () => {
    // Kiểm tra bắt buộc chọn cấp trên
    ...
    // Đảm bảo directSupervisor là _id (string)
    let submitForm = { ...form };
    ...
    try {
      ...
      if (!body.password) delete body.password; // không đổi password khi update
      ...
      console.log('Create/Update user response:', respData);
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                <div className="relative">
                  ...
                  {/* Hiển thị tên trong textbox luôn vì select native sẽ show label */}
                </div>
              </div>
            </div>
