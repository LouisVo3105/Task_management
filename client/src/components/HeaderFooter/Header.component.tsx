...
const Header: React.FC<HeaderProps> = () => {
  return (
    <header className="flex flex-wrap gap-5 justify-between px-20 py-5 w-full font-bold text-center text-blue-900 bg-cyan-600 max-md:px-5 max-md:max-w-full">
      ...
      <div
        className="flex items-center justify-center px-4 py-1 border-2 border-white text-white rounded-full text-base font-semibold hover:bg-cyan-700 hover:text-white transition-colors duration-200 cursor-pointer my-auto min-w-[80px] min-h-[36px]"
        onClick={() => {
          /* TODO: handle login */
        }}
      >
